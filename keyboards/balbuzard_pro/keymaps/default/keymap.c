...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_NO, MO(2), KC_LSFT, KC_LGUI, RALT_T(KC_ENT), KC_SPC, MO(1), KC_NO
    ),
    ...
    [1] = LAYOUT(
        ...
        KC_NO, MO(3), KC_LSFT, KC_LGUI, KC_NO, KC_NO, KC_TRNS, KC_NO
    ),
    ...
    [2] = LAYOUT(
        ...
        KC_NO, KC_TRNS, KC_NO, KC_NO, KC_ENT, KC_BSPC, KC_TAB, KC_NO
    ),
